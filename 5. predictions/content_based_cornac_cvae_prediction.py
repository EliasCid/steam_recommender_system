# This Script implements content based predictions using CVAE from Cornac.
#%%
import mlflow
import pandas as pd
import os
...
version = max((int(v.version) for v in client.get_latest_versions('content_based_cornac_cvae')))
model = mlflow.pyfunc.load_model(f'models:/content_based_cornac_cvae/{version}')
