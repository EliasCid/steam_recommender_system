# This Script implements collaborative filtering predictions using VAECF from Cornac.
#%%
import mlflow
import pandas as pd
import os
...
version = max((int(v.version) for v in client.get_latest_versions('collaborative_filtering_cornac_deep_learning')))
model = mlflow.pyfunc.load_model(f'models:/collaborative_filtering_cornac_deep_learning/{version}')
