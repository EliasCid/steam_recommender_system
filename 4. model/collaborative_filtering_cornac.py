# This Script implements a collaborative filtering model using multiple models from Cornac and logs it to MLflow.
#%%
import os
import glob
import mlflow
...
from cornac.models import MF, PMF, BPR, MMMF, SVD, WBPR
