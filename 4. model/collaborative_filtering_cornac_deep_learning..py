# This Script implements a collaborative filtering model using VAECF from Cornac and logs it to MLflow.
#%%
import os
import glob
import mlflow
...
mlflow.set_experiment(experiment_id=404580702548595703)
...
rs = RatioSplit(data=data, test_size=0.2, rating_threshold=4.0, seed=42)
