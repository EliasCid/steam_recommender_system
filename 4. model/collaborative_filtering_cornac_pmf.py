# This Script implements a collaborative filtering model using PMF from Cornac and logs it to MLflow.
#%%
import os
import glob
import mlflow
...
mlflow.set_experiment(experiment_id=194767319095067766)
