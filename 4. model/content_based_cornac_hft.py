# This Script implements a content-based filtering model using HFT from Cornac and logs it to MLflow.
#%%
import os
import glob
import pandas as pd
...
from cornac.models import HFT
from cornac.metrics import MAE, RMSE, Precision, Recall, NDCG, AUC, MAP

# MLflow configuration
mlflow.set_tracking_uri('http://127.0.0.1:5000/')
mlflow.set_experiment(experiment_id=371259768685409907)
